...
The Modem library is Nordic Semiconductor's implementation of the BSD `Socket API`_, which is a set of standard function calls that can be used in an application.
...
The Modem library is the primary interface for operating the nRF9160 modem and to establish LTE-M, NB-IoT, and GNSS connections.
